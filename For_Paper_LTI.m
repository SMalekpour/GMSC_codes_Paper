...
f2=0.28;
for ii=3:n
xx1(ii)=sin(2*pi*f1)*r(ii-1,1)+2*cos(2*pi*f1)*xx1(ii-1)-xx1(ii-2);
xx2(ii)=sin(2*pi*f2)*r(ii-1,2)+2*cos(2*pi*f2)*xx2(ii-1)-xx2(ii-2);
y1(ii)=sin(2*pi*2*f1)*r(ii-1,3)+2*cos(2*pi*2*f1)*y1(ii-1)-y1(ii-2);
y2(ii)=sin(2*pi*f2)*r(ii-1,4)+2*cos(2*pi*f2)*y2(ii-1)-y2(ii-2);
end
x=[xx1;xx2];
y=[y1;y2];
